...
namespace XamarinConsoleTests
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //each of the language api calls to check the definition of that word from the dictionary should contain 2 parameters, firstly the string language code 
        ...
        private static async void APIRussianCall2()
        {
            ...
            // take first item in each array/list
            var result = x[0].meanings[0].definitions[0].definition;  
        }
